...
from .AttModel_preh import TopDownModel as preh_model
from .AttModel_preh_gate import TopDownModel as preh_gate_model
def setup(opt):
    ...
    elif opt.caption_model == 'topdown_preh':
        model = preh_model(opt)
    elif opt.caption_model == 'topdown_preh_gate':
        model = preh_gate_model(opt)
    # StackAtt
