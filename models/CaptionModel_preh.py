...
class CaptionModel(nn.Module):
    ...
    def beam_search(self, pre_h, init_state, init_logprobs, tmp_fc_feats, tmp_att_feats, tmp_p_att_feats, tmp_att_masks, **kwargs):
        #pre_h, state, logprobs, tmp_fc_feats, tmp_att_feats, tmp_p_att_feats, tmp_att_masks, opt=opt
        ...
        #args = list(args)
        args = [pre_h, tmp_fc_feats, tmp_att_feats, tmp_p_att_feats, tmp_att_masks]
        ...
        for t in range(self.seq_length + group_size - 1):
            for divm in range(group_size): 
                if t >= divm and t <= self.seq_length + divm - 1:
                    ...
                    #pdb.set_trace()
                    logprobs_table[divm], state_table[divm],pre_h = self.get_logprobs_state(it.cuda(), tmp_fc_feats, tmp_att_feats, tmp_p_att_feats, tmp_att_masks, state_table[divm], pre_h)
